...
class MolePage extends StatefulWidget {
  MolePage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MolePageState createState() => _MolePageState();
}

class _MolePageState extends State<MolePage> {
                    ...
                    Row(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Text(
                              "计算公式：质量 (mg) = 浓度 (mM) × 体积 (mL) × 分子量 (g/mol)",
                              style: TextStyle(
